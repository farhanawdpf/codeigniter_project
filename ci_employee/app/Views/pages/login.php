            ...
            <form action="/login" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <span class="input-group-text bg-transparent  border-0 border-bottom" id="pass-addon"><i class="fa fa-unlock-alt"></i></span>
                    </div>
                </div>
                ...
                <center><a href="/register">Register New Account</a></center>
            </form>
        </div>
    </div>
</div>